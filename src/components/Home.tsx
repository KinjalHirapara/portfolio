...
const Home: React.FC = () => {
  ...
  const replayViewport = { once: false, amount: 0.35 } as const;
      ...
      <div className="flex flex-col-reverse md:flex-row gap-6 md:gap-12 lg:gap-20 items-center md:items-center flex-1 max-w-6xl mx-auto px-4 pt-[110px] pb-6 mobile-landscape-padding">
        <div className="flex flex-col gap-4 md:gap-6 flex-1 w-full">
          ...
          <motion.div
            ...
            className="flex flex-wrap gap-3 md:gap-4 mt-1 md:mt-2"
          >
            <a
              href="#projects"
              className="cursor-pointer group px-4 sm:px-5 md:px-6 py-2.5 md:py-3 rounded-full bg-[var(--color-primary)] text-sm md:text-base text-white font-semibold transition active:translate-y-0.5 inline-flex items-center gap-2"
            >
              View Projects
